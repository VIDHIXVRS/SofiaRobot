...
buttons = [
    ...
    [
        InlineKeyboardButton(text="✨ Uᴘᴅᴀᴛᴇs✨", url=f"https://t.me/SOFIA_X_UPDATES"),
    ...
    [
        ...
        InlineKeyboardButton(text="☁️ Sᴏᴜʀᴄᴇ ☁️", url=f"https://github.com/TheAnonymous2005/FallenRobot"),
    ],
]
